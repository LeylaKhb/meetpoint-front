        ...
        <BrowserRouter>
            <Layout>
                <Routes>
                    ...
                    <Route path="/personal_account" element={<ProtectedRouteWithSheetCheck element={<PersonalAccount/>}/>}/>
                    <Route path="/current_meetings" element={<ProtectedRouteWithSheetCheck element={<CurrentMeetings/>}/>}/>
                    <Route path="/meetings_history" element={<ProtectedRouteWithSheetCheck element={<MeetingsHistory/>}/>}/>
